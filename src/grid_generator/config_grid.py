...
# Keep Out areas. 
phi_min_deg = -170.0 # Phi axis limits (degrees, azimuth)
phi_max_deg =  180.0 # Phi axis limits (degrees, azimuth)
bottom_cutoff_mm  = 30   # Remove bottom‐cap points from center (mm) for support pole

# --- Wall Thickness ("Magnetic Pull") ---
wall_thickness_mm  = 50.0   # The maximum distance points can be pulled outwards
P_side = 0.5 # Magntic pull bias on cylinder sides
P_caps = 0.8 # Magntic pull bias on cylinder caps
